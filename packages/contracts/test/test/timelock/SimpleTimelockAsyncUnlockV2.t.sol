...
contract SimpleTimelockAsyncUnlockV2 is Initializable, UUPSUpgradeable, TimelockAsyncUnlock {
    ...
    function deposit(address account, uint256 depositPeriod, uint256 amount) public {
    ...
    function redeem(address owner, uint256 unlockPeriod) public {
        (uint256[] memory depositPeriods, uint256[] memory amounts) = unlock(owner, unlockPeriod);
