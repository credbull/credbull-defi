...
contract CredbullFixedYieldVaultFactory is CredbullVaultFactory {
     ...
     */
    function createVault(CredbullFixedYieldVault.FixedYieldVaultParams memory _params, string memory options)
        public
        virtual
        onlyRole(OPERATOR_ROLE)
        onlyAllowedCustodians(_params.maturityVaultParams.baseVaultParams.custodian)
        returns (address)
    {
