...
function getArtifactOfContract(contractName) {
  let artifactJson;
  if (['ERC1155MintableBurnable', 'SimpleTimelockAsyncUnlock'].includes(contractName)) {
...
function main() {
  const current_path_to_broadcast = path.join(__dirname, '../..', 'broadcast/DeployTimelockAsyncUnlock.s.sol'); // data loading variant
  ...
  const TARGET_DIR = '../../spikes/spike-timelock-async/packages/nextjs/contracts/';
