...
export interface WindowVaultMockInterface extends utils.Interface {
  functions: {
...
export interface WindowVaultMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WindowVaultMockInterface;
