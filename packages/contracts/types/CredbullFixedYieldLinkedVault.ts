...
export interface CredbullFixedYieldLinkedVaultInterface
...
export interface CredbullFixedYieldLinkedVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CredbullFixedYieldLinkedVaultInterface;
