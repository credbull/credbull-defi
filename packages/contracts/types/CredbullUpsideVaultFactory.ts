...
export interface CredbullUpsideVaultFactoryInterface extends utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "OPERATOR_ROLE()": FunctionFragment;
    "createUpsideVault(address,address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "createUpsideVault",
...
export interface CredbullUpsideVaultFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CredbullUpsideVaultFactoryInterface;
