...
export interface FixedYieldLinkedVaultInterface extends utils.Interface {
  functions: {
...
export interface FixedYieldLinkedVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FixedYieldLinkedVaultInterface;
