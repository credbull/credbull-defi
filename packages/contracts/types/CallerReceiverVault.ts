...
export interface CallerReceiverVaultInterface extends utils.Interface {
  functions: {
...
export interface CallerReceiverVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CallerReceiverVaultInterface;
