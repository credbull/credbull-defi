...
export interface CredbullBaseVaultInterface extends utils.Interface {
  functions: {
...
export interface CredbullBaseVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CredbullBaseVaultInterface;
