...
export interface FixedYieldVaultInterface extends utils.Interface {
  functions: {
...
export interface FixedYieldVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FixedYieldVaultInterface;
