...
export interface CredbullBaseVaultMockInterface extends utils.Interface {
  functions: {
...
export interface CredbullBaseVaultMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CredbullBaseVaultMockInterface;
