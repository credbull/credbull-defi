...
export interface CredbullVaultWithUpsideFactoryInterface
  ...
  functions: {
    ...
    "setRequiredCollateral(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setRequiredCollateral",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface CredbullVaultWithUpsideFactory extends BaseContract {
  ...
  interface: CredbullVaultWithUpsideFactoryInterface;
  ...
  functions: {
    ...
    setRequiredCollateral(
      _requiredCollateral: BigNumberish,
      overrides?: Overrides & { from?: string }
    ): Promise<ContractTransaction>;
