...
export interface CredbullFixedYieldVaultInterface extends utils.Interface {
  functions: {
...
export interface CredbullFixedYieldVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CredbullFixedYieldVaultInterface;
