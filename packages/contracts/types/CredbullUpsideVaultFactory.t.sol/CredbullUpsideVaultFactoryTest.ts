...
export interface CredbullUpsideVaultFactoryTestInterface
  ...
  functions: {
    ...
    "test__deposit_should_succeed()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test__deposit_should_succeed",
    values?: undefined
  ): string;
...
export interface CredbullUpsideVaultFactoryTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CredbullUpsideVaultFactoryTestInterface;
  ...
  callStatic: {
    ...
    test__deposit_should_succeed(overrides?: CallOverrides): Promise<void>;
  };
