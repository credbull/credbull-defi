...
export interface WhitelistVaultMockInterface extends utils.Interface {
  functions: {
...
export interface WhitelistVaultMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WhitelistVaultMockInterface;
