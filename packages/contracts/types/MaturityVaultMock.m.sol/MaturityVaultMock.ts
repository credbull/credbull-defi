...
export interface MaturityVaultMockInterface extends utils.Interface {
  functions: {
    ...
    "toogleMaturityCheck(bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "toogleMaturityCheck",
    values: [boolean]
  ): string;
  encodeFunctionData(
...
export interface MaturityVaultMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MaturityVaultMockInterface;
