...
export interface CredbullVaultFactoryTestInterface extends utils.Interface {
  functions: {
    ...
    "test__CreateVaultFromFactory()": FunctionFragment;
    "test__ShouldAllowAdminToChangeOperator()": FunctionFragment;
    "test__ShouldReturnVaultAtIndex()": FunctionFragment;
    "test__ShouldReturnVaultExistStatus()": FunctionFragment;
    "test__ShouldRevertCreateVaultOnUnAuthorizedUser()": FunctionFragment;
    "test__VaultCountShouldReturnCorrectVault()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test__CreateVaultFromFactory"
      | "test__ShouldAllowAdminToChangeOperator"
      | "test__ShouldReturnVaultAtIndex"
      | "test__ShouldReturnVaultExistStatus"
      | "test__ShouldRevertCreateVaultOnUnAuthorizedUser"
      | "test__VaultCountShouldReturnCorrectVault"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test__CreateVaultFromFactory",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test__ShouldAllowAdminToChangeOperator",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test__ShouldReturnVaultAtIndex",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test__ShouldReturnVaultExistStatus",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test__ShouldRevertCreateVaultOnUnAuthorizedUser",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test__VaultCountShouldReturnCorrectVault",
    values?: undefined
  ): string;
...
export interface CredbullVaultFactoryTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CredbullVaultFactoryTestInterface;
  ...
  callStatic: {
    ...
    test__CreateVaultFromFactory(overrides?: CallOverrides): Promise<void>;

    test__ShouldAllowAdminToChangeOperator(
      overrides?: CallOverrides
    ): Promise<void>;

    test__ShouldReturnVaultAtIndex(overrides?: CallOverrides): Promise<void>;
