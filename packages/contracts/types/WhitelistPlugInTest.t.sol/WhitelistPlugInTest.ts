...
export interface WhitelistPlugInTestInterface extends utils.Interface {
  functions: {
    ...
    "test__WhitelistVault__RevertDepositIfReceiverNotWhitelisted()": FunctionFragment;
    "test__WhitelistVault__ShouldNotRevertOnWhitelistModifier()": FunctionFragment;
    "test__WhitelistVault__ShouldToggleWhitelist()": FunctionFragment;
    "test__WhitelistVault__SucessfulDepositOnWhitelistVault()": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "test__WhitelistVault__RevertDepositIfReceiverNotWhitelisted"
      | "test__WhitelistVault__ShouldNotRevertOnWhitelistModifier"
      | "test__WhitelistVault__ShouldToggleWhitelist"
      | "test__WhitelistVault__SucessfulDepositOnWhitelistVault"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test__WhitelistVault__RevertDepositIfReceiverNotWhitelisted",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test__WhitelistVault__ShouldNotRevertOnWhitelistModifier",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test__WhitelistVault__ShouldToggleWhitelist",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test__WhitelistVault__SucessfulDepositOnWhitelistVault",
    values?: undefined
  ): string;
...
export interface WhitelistPlugInTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WhitelistPlugInTestInterface;
