...
exports.__mockMint = exports.decodeError = exports.generateSigner = exports.generateAddress = exports.signer = exports.login = exports.headers = void 0;
const contracts_1 = require("@credbull/contracts");
const crypto_1 = __importDefault(require("crypto"));
const ethers_1 = require("ethers");
const headers = (session) => {
    return {
        headers: Object.assign({ 'Content-Type': 'application/json' }, ((session === null || session === void 0 ? void 0 : session.access_token) ? { Authorization: `Bearer ${session.access_token}` } : {})),
    };
};
...
const login = (email, password) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const signIn = yield fetch(`http://localhost:3001/auth/api/sign-in`, Object.assign({ method: 'POST', body }, (0, exports.headers)()));
    return signIn.json();
});
exports.login = login;
...
const __mockMint = (to, amount, vault, signer) => __awaiter(void 0, void 0, void 0, function* () {
