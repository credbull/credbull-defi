...
class CredbullSDK {
    ...
    handleError(contract, error) {
        var _a, _b, _c, _d, _e;
        if ((_b = (_a = error.error) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.data) {
            (0, utils_1.decodeContractError)(contract, error.error.data.data);
        }
        else if ((_e = (_d = (_c = error.error) === null || _c === void 0 ? void 0 : _c.error) === null || _d === void 0 ? void 0 : _d.error) === null || _e === void 0 ? void 0 : _e.data) {
