...
const deployedContracts = {
  31337: {
    ...
    "SimpleUSDC#0": {
      address: "0xf47e3b0a1952a81f1afc41172762cb7ce8700133",
      abi: [
        {
          type: "constructor",
          inputs: [
    ...
    "SimpleVault#0": {
      ...
      abi: [
        ...
        {
          type: "error",
          name: "CredbullVault__InvalidAsset",
          inputs: [
            {
              name: "",
              type: "address",
        ...
        {
          type: "error",
          name: "CredbullVault__InvalidCustodianAddress",
          inputs: [
            {
              name: "",
              type: "address",
    ...
    "CredbullFixedYieldVaultFactory#0": {
      ...
      abi: [
          ...
          inputs: [
            {
              name: "params",
              type: "tuple",
              internalType: "struct FixedYieldVault.FixedYieldVaultParams",
              components: [
                {
                  name: "maturityVault",
                  type: "tuple",
                  internalType: "struct MaturityVault.MaturityVaultParams",
                  components: [
                    {
                      name: "vault",
                      type: "tuple",
                ...
                },
                {
                  name: "roles",
                  type: "tuple",
                  internalType: "struct FixedYieldVault.ContractRoles",
                  components: [
                    {
                      name: "owner",
                      type: "address",
                ...
                },
                {
                  name: "windowPlugin",
                  type: "tuple",
                  internalType: "struct WindowPlugin.WindowPluginParams",
                  components: [
                    {
                      name: "depositWindow",
                      type: "tuple",
                      internalType: "struct WindowPlugin.Window",
                      components: [
                        {
                          name: "opensAt",
                          type: "uint256",
                ...
                },
                {
                  ...
                  type: "tuple",
                  internalType: "struct WhiteListPlugin.WhiteListPluginParams",
                  components: [
                    {
                ...
                },
                {
                  name: "maxCapPlugin",
                  type: "tuple",
                  internalType: "struct MaxCapPlugin.MaxCapPluginParams",
                  components: [
                    {
                      name: "maxCap",
                      type: "uint256",
        ...
        {
          type: "error",
          name: "CredbullVaultFactory__CustodianNotAllowed",
          inputs: [],
        },
        {
          type: "error",
          name: "CredbullVaultFactory__InvalidCustodianAddress",
          inputs: [],
        },
        {
          type: "error",
          name: "CredbullVaultFactory__InvalidOperatorAddress",
          inputs: [],
        },
        {
          type: "error",
          name: "CredbullVaultFactory__InvalidOwnerAddress",
          inputs: [],
        },
      ],
      inheritedFunctions: {},
    },
    "CredbullUpsideVaultFactory#0": {
          ...
          inputs: [
            {
              name: "params",
              type: "tuple",
              internalType: "struct UpsideVault.UpsideVaultParams",
              components: [
                {
                  name: "fixedYieldVault",
                  type: "tuple",
                  internalType: "struct FixedYieldVault.FixedYieldVaultParams",
                  components: [
                    {
    ...
    "TripleRateYieldStrategy#0": {
      address: "0xf4c5c29b14f0237131f7510a51684c8191f98e06",
      abi: [
        {
          type: "function",
          name: "calcPrice",
    ...
    "RedeemOptimizerFIFO#0": {
      address: "0x934a389cabfb84cdb3f0260b2a4fd575b8b345a3",
      abi: [
        {
          type: "constructor",
          inputs: [
    ...
    "LiquidContinuousMultiTokenVault#0": {
      address: "0xc91b651f770ed996a223a16da9ccd6f7df56c987",
      abi: [
        {
          type: "function",
          name: "CLOCK_MODE",
    ...
    "ERC1967Proxy#0": {
      address: "0x787c6666213624d788522d516847978d7f348902",
      abi: [
        {
          type: "constructor",
          inputs: [
