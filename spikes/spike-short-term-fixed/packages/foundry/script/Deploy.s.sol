...
contract DeployScript is ScaffoldETHDeploy {
    ...
    function run() external {
        ...
        console.logString(string.concat("SimpleToken deployed at: ", vm.toString(address(simpleToken))));
        ...
        console.logString(string.concat("TimelockInterestVault deployed at: ", vm.toString(address(timelockVault))));
