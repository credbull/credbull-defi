...
import { AxelarValuedExpressExecutable } from
  "../../express/AxelarValuedExpressExecutable.sol";
...
contract AxelarValuedExpressExecutableTest is AxelarValuedExpressExecutable {
  ...
  constructor(
    address gateway_
  ) AxelarValuedExpressExecutable(gateway_) { }

  function setExpressToken(
    address expressToken_
  ) external {
    expressToken = expressToken_;
  }

  function setCallValue(
    uint256 callValue_
  ) external {
