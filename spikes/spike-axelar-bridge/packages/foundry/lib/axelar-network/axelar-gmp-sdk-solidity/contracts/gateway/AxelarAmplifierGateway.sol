...
import { IAxelarAmplifierGateway } from
  "../interfaces/IAxelarAmplifierGateway.sol";
...
contract AxelarAmplifierGateway is
  ...
  IAxelarAmplifierGateway
{
  ...
  function approveMessages(
    ...
    bytes32 dataHash =
      keccak256(abi.encode(CommandType.ApproveMessages, messages));
  ...
  function rotateSigners(
    ...
    bytes32 dataHash =
      keccak256(abi.encode(CommandType.RotateSigners, newSigners));
   ...
   */
  function _axelarAmplifierGatewayStorage()
    private
    pure
    returns (AxelarAmplifierGatewayStorage storage slot)
  {
    assembly {
