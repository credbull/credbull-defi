...
import { IAxelarGMPGatewayWithToken } from
  "../interfaces/IAxelarGMPGatewayWithToken.sol";
import { IAxelarGMPExecutableWithToken } from
  "../interfaces/IAxelarGMPExecutableWithToken.sol";
 ...
 */
abstract contract AxelarGMPExecutableWithToken is
  IAxelarGMPExecutableWithToken,
  AxelarGMPExecutable
{
  /**
  ...
  function gatewayWithToken()
    internal
    view
    returns (IAxelarGMPGatewayWithToken)
  {
