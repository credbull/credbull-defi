...
abstract contract BaseAmplifierGateway is IBaseAmplifierGateway {
  ...
  function isMessageApproved(
    ...
    return _isContractCallApproved(
  ...
  function isMessageExecuted(
    ...
    return _baseAmplifierGatewayStorage().approvals[messageToCommandId(
      sourceChain, messageId
    )] == MESSAGE_EXECUTED;
  }
  ...
  function validateMessage(
    ...
    bytes32 commandId = messageToCommandId(sourceChain, messageId);
    valid =
      _validateContractCall(commandId, sourceChain, sourceAddress, payloadHash);
  }
  ...
  function isCommandExecuted(
    ...
    return
      _baseAmplifierGatewayStorage().approvals[commandId] != MESSAGE_NONEXISTENT;
  }
  ...
  function _approveMessages(
    ...
    for (uint256 i; i < length; ++i) {
      ...
      bytes32 commandId =
        messageToCommandId(message.sourceChain, message.messageId);
   ...
   */
  function _baseAmplifierGatewayStorage()
    private
    pure
    returns (BaseAmplifierGatewayStorage storage slot)
  {
    assembly {
