...
import { IAxelarServiceGovernance } from
  "../interfaces/IAxelarServiceGovernance.sol";
 ...
 */
contract AxelarServiceGovernance is
  ...
  IAxelarServiceGovernance
{
  ...
  function _processCommand(
    ...
    if (
      commandType == uint256(ServiceGovernanceCommand.ScheduleTimeLockProposal)
    ) {
      ...
      commandType == uint256(ServiceGovernanceCommand.CancelTimeLockProposal)
    ) {
      ...
      commandType == uint256(ServiceGovernanceCommand.ApproveMultisigProposal)
    ) {
      ...
      commandType == uint256(ServiceGovernanceCommand.CancelMultisigApproval)
    ) {
      multisigApprovals[proposalHash] = false;
