...
contract MockGateway is IAxelarGateway {
  ...
  function isContractCallApproved(
    ...
    return bools[_getIsContractCallApprovedKey(
  ...
  function isContractCallAndMintApproved(
    ...
    return bools[_getIsContractCallApprovedWithMintKey(
      commandId,
      sourceChain,
      sourceAddress,
      contractAddress,
  ...
  function _deployToken(
    ...
    tokenAddress =
      address(new ERC20MintableBurnable{ salt: salt }(name, symbol, decimals));
  }
  ...
  function _burnTokenFrom(
    ...
    if (tokenType == TokenType.External) {
      burnSuccess = _callERC20Token(
        ...
        abi.encodeWithSelector(
          IERC20.transferFrom.selector, sender, address(this), amount
        )
      );
    ...
    if (tokenType == TokenType.InternalBurnableFrom) {
      burnSuccess = _callERC20Token(
        tokenAddress,
        abi.encodeWithSelector(
          IERC20MintableBurnable.burn.selector, sender, amount
        )
      );
  ...
  function _getTokenMintAmountKey(
    ...
    return
      keccak256(abi.encodePacked(PREFIX_TOKEN_DAILY_MINT_AMOUNT, symbol, day));
  }
  ...
  function _setContractCallApproved(
    ...
    bools[_getIsContractCallApprovedKey(
      commandId, sourceChain, sourceAddress, contractAddress, payloadHash
    )] = true;
  }
  ...
  function _setContractCallApprovedWithMint(
    ...
    bools[_getIsContractCallApprovedWithMintKey(
      commandId,
      sourceChain,
      sourceAddress,
      contractAddress,
