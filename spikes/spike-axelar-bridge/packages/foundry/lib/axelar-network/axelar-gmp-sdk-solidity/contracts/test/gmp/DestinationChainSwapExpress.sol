...
import { AxelarExpressExecutable } from
  "../../express/AxelarExpressExecutable.sol";
import { IERC20 } from "../../interfaces/IERC20.sol";
import { DestinationChainTokenSwapper } from
  "./DestinationChainTokenSwapper.sol";
...
contract DestinationChainSwapExpress is AxelarExpressExecutable {
  ...
  ) AxelarExpressExecutable(gatewayAddress) {
  ...
  function _executeWithToken(
    ...
    (string memory tokenSymbolB, string memory recipient) =
    ...
    uint256 convertedAmount =
      swapper.swap(tokenA, tokenB, amount, address(this));
